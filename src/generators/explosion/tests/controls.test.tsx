...
describe('combustion explosion controls', () => {
  it('renders fixed-seed shape cards and shape-specific body controls', () => {
    ...
    expect(body.match(/aria-disabled="true"/g)).toHaveLength(2)
    expect(body).toContain('Legacy radial')
    expect(body.indexOf('Legacy radial')).toBeLessThan(body.indexOf('Game fireball'))
    expect(body.indexOf('Smoke burst')).toBeLessThan(body.indexOf('Directional blast'))
    expect(body.indexOf('Smoke burst')).toBeLessThan(body.indexOf('Turbulent fireball'))
    ...
    const directional = renderControls('body', 'en', { ...MODERN_EXPLOSION_PARAMETERS, body: { ...MODERN_EXPLOSION_PARAMETERS.body, shape: 'directionalBlast' } })
    expect(directional).toContain('Blast width')
    expect(directional).not.toContain('Lobe expansion')
    ...
    expect(directional).not.toContain('Smoke puff count')
    expect(directional).not.toContain('Smoke motion')
  })
