...
describe('projectile model', () => {
  ...
  it('rejects invalid enums, ranges, booleans, and palettes', () => {
    ...
    expect(() => assertValidProjectileParameters({ ...base, crystalGlintStrength: -0.1 })).toThrow(/crystalGlintStrength/)
    expect(() => assertValidProjectileParameters({ ...base, crystalGlintSpeed: 3.1 })).toThrow(/crystalGlintSpeed/)
