    ...
    case 'shape':
      return (
        <div className="control-list">
          ...
          <NumberControl label={t('slash.controls.tipLength.label')} description={t('slash.controls.tipLength.description')} value={parameters.tipLength} minimum={0} maximum={1} step={0.01} scale={100} unit="%" onChange={(value) => update('tipLength', value)} />
