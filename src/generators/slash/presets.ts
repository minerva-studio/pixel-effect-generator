...
import { readEnum, readInteger, readNumber, readOptionalNumber, readPalette, serializeSlashParameters } from './project'
...
export const SLASH_BUILTIN_PRESETS: readonly GeneratorPreset[] = [
  ...
  },
  {
    id: 'pointedStrike',
    name: 'Pointed Strike',
    description: 'A long, centered blade tip with a clean directional finish.',
    payload: {
      palette: [
        { r: 255, g: 255, b: 255, a: 255 },
        { r: 154, g: 198, b: 255, a: 255 },
