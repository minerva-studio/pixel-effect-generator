...
const enTree = {
  ...
  explosion: {
    ...
    controls: {
      ...
      shockwaveMode: { label: 'Shockwave type', description: 'Disable the wave or choose directional arcs or a full ring.' },
      shockwaveThickness: { label: 'Thickness', description: 'Radial band thickness only; it never changes the arc curvature.' },
      ...
      shockwaveArcCount: { label: 'Arc count', description: 'Exact number of angularly balanced directional wave sectors.' },
      shockwaveArcSpan: { label: 'Arc span', description: 'Angular width of each directional wave sector.' },
    ...
    options: {
      ...
      shockwaveNone: 'Off',
      shockwaveLobeArcs: 'Directional arcs',
...
export const zhCN: MessageTree = {
  ...
  explosion: {
    ...
    controls: {
      ...
      shockwaveMode: { label: '冲击波类型', description: '关闭冲击波，或选择定向弧段和完整圆环。' },
      shockwaveThickness: { label: '厚度', description: '只改变径向线宽，不再改变弧段曲率。' },
      ...
      shockwaveArcCount: { label: '弧段数量', description: '围绕中心均衡分布的定向波前准确数量。' },
      shockwaveArcSpan: { label: '单段张角', description: '每段定向波前占据的角度。' },
