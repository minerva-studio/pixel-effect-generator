...
const enTree = {
  ...
  explosion: {
    ...
    controls: {
      ...
      pressureWidth: { label: 'Legacy pressure width', description: 'Compatibility value for imported older presets.' },
      pressureSharpness: { label: 'Legacy front sharpness', description: 'Compatibility value for imported older presets.' },
    ...
    options: {
      ...
      directionalBlast: 'Directional blast',
    ...
    shapeDescriptions: {
      ...
      turbulentFireball: 'Coming soon: an upward-rolling asymmetric flame body.',
      shockBlast: 'Coming soon: a bright core driving broken shell plates.',
      directionalBlast: 'A short wide blast projects along one direction.',
    ...
    presets: {
      ...
      directionalBlast: { name: 'Directional Blast', description: 'A short broad blast projected along one readable direction.' },
...
export const zhCN: MessageTree = {
  ...
  explosion: {
    ...
    controls: {
      ...
      pressureWidth: { label: '旧压力宽度', description: '旧预设导入时保留的兼容字段。' },
      pressureSharpness: { label: '旧前缘锐度', description: '旧预设导入时保留的兼容字段。' },
    ...
    shapeDescriptions: {
      ...
      turbulentFireball: '即将推出：向上卷升的不对称翻滚火焰。',
      shockBlast: '即将推出：亮核推动破碎外壳裂片。',
      directionalBlast: '沿一个方向释放的短而宽爆破体积。',
    ...
    presets: {
      ...
      directionalBlast: { name: '定向爆破', description: '沿一个清晰方向释放的短而宽爆破。' },
...
const PRESET_DISPLAY_KEYS: Readonly<Record<string, Readonly<Record<string, PresetDisplayKeys>>>> = {
  ...
  explosion: {
      ...
      directionalBlast: { name: 'explosion.presets.directionalBlast.name', description: 'explosion.presets.directionalBlast.description' },
