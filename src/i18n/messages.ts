...
const enTree = {
  ...
  explosion: {
    name: 'Explosion',
    description: 'Physical fire, pressure release, rolling fire masses, and retro blasts.',
    ...
    controls: {
      ...
      churnAmount: { label: 'Fire-mass expansion', description: 'Controls how strongly individual fire masses keep rolling outward after their staggered formation.' },
      lobeCount: { label: 'Fire-mass count', description: 'Number of overlapping fire masses forming the rolling fireball.' },
    ...
    options: {
      ...
      balanced: 'Balanced',
      drifting: 'Drifting',
      rollingFireball: 'Rolling fireball',
    ...
    shapeDescriptions: {
      rollingFireball: 'Overlapping fire masses roll outward as one connected explosion.',
    ...
    presets: {
      rollingFireball: { name: 'Rolling Fireball', description: 'Overlapping fire masses expand and cool on staggered schedules.' },
...
export const zhCN: MessageTree = {
  ...
  explosion: {
    name: '燃烧爆炸',
    description: '物理火焰、压力释放、翻滚火团与复古爆炸。',
    previewTitle: '火焰爆发研究',
    categories: {
    ...
    controls: {
      ...
      churnAmount: { label: '火团膨胀', description: '控制各火团错时成形后继续翻滚并向外膨胀的幅度。' },
      lobeCount: { label: '火团数量', description: '构成翻滚火团的重叠火团数量。' },
    ...
    shapeDescriptions: {
      rollingFireball: '多个火团作为一个连通爆炸体持续向外翻滚膨胀。',
    ...
    presets: {
      rollingFireball: { name: '翻滚火团', description: '多个火团错时膨胀、翻滚并逐步冷却。' },
