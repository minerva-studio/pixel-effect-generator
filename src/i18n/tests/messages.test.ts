...
describe('translation resources', () => {
  ...
  it('maps stable generator and category ids to translation keys', () => {
    ...
    expect(translate(messagesForLocale('zh-CN'), 'explosion.categories.shape.label')).toBe('形状')
    ...
    expect(translate(messagesForLocale('zh-CN'), 'projectile.categories.shape.label')).toBe('形状')
